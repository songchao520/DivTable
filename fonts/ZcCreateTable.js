  ...
  CreateZcTable.prototype = {
  	initTable:function(){
		...
		if(isauto == "true"){
  		...
  		for(var i=0;i<colsname.length;i++){
  			if(i == 0){
  				...
  				thinputdiv = thinputdiv + '<div style="float:left;width:'+contentwidth+'px;height:'+titleheight+'px;'+borderline+' '+ispiaofuhtml+'" class="th'+i+' '+colclassname[i]+'th zctablethtd" i="'+i+'">'+colsname[i]+'</div>';
  			}else{
		...
		if(contentborder == "true"){
  		...
  		var trzerodiv = '<div tdbackgroundcolor="'+tdbackgroundcolor+'" style="width:100%;display:none;height:'+contentheight+'px;float:left;background:'+tdbackgroundcolor+';line-height:'+parseFloat(contentheight)+'px;'+contentborderhtml+' '+contentleftright+'" class="tabletr'+0+' zctabletr hidezctabletr" '+oddeven+'>';
  		var borderwidth = "";
